...
export default function EditCampaignScreen({ navigation, route }) {
  ...
  // Function to delete the current campaign and return to HomeScreen
  async function deleteCampaign() {
    // DELETE request to delete campaign from database
    try {
      const response = await fetch(`${config.campaign}/${data._id}`,
        {
          method: 'DELETE'
        }
      )
